...
MLVFS mounts the MLV directory (automatic step)
    ↓
Open Davinci Resolve or MLVApp
```

Some tools also require additional software such as:

**FFmpeg - https://gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip**
...
* Automatically open the copied MLVs in MLVApp
...
MagicDump.cmd
```
![MagicDump](https://i.ibb.co/zWVf85kD/image.png)
